...
class MusicPageWidget extends StatefulWidget {
  const MusicPageWidget({Key? key}) : super(key: key);

  @override
  _MusicPageWidgetState createState() => _MusicPageWidgetState();
}

class _MusicPageWidgetState extends State<MusicPageWidget> with TickerProviderStateMixin {
                  ...
                  child: Stack(
                    children: [
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(0.0, 13.0, 50.0, 0.0),
                          child: Text(
                            'Noise Cancellation',
                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                  fontFamily: 'Manrope',
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 75.0, 0.0),
                          child: Switch(
                            value: _model.switchValue ??= true,
                            onChanged: (newValue) async {
                              setState(() => _model.switchValue = newValue);
                            },
                            activeColor: Color(0xFF33DE2F),
                            activeTrackColor: Color(0xFF79FC77),
