...
import 'speech_page_model.dart';
export 'speech_page_model.dart';

class SpeechPageWidget extends StatefulWidget {
  const SpeechPageWidget({Key? key}) : super(key: key);

  @override
  _SpeechPageWidgetState createState() => _SpeechPageWidgetState();
}

class _SpeechPageWidgetState extends State<SpeechPageWidget> with TickerProviderStateMixin {
  late SpeechPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpeechPageModel());
    FFAppState().getDataPref();
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                // context.pop();
                                context.pushReplacementNamed('RecordPage');
                              },
                            ),
                          ),
                          Align(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed('SpeechLibrary');
                                },
                                text: 'Library',
                                icon: Icon(
                                  Icons.list_rounded,
