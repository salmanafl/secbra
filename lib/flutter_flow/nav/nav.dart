...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => SpeechPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => SpeechPageWidget(),
        ),
        FFRoute(
          name: 'SpeechPage',
          path: '/speechPage',
          builder: (context, params) => SpeechPageWidget(),
        ),
        FFRoute(
          name: 'RecordLibrary',
          path: '/recordLibrary',
          builder: (context, params) => RecordLibraryWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'SpeechLibrary',
          path: '/speechLibrary',
          builder: (context, params) => SpeechLibraryWidget(),
        ),
        FFRoute(
          name: 'MusicPage',
          path: '/musicPage',
